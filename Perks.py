...
def gen_perks():
    ...
    perks["glass_cannon"] = Perks(name="glass cannon", str_mult = 5, sta_mult = 0.2, description = "Tres fort, mais tres fragile")
    ...
    perks["tentacle"] = Perks(name="tentacle", str_mult = 1.5, str_mod = 20, description = "Vos tentacules vous aide a porter plus")
