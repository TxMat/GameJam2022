...
def gen_level():
    ...
    level ["mine dangereuse"] = Level(name="mine dangereuse", ore_list=["Columbite","granit","saphir"] ,dna_list=["n1g6","i8a5","z9g1"],description="une mine pleine de ressources",danger_lvl=3,length_range=(3,15))
